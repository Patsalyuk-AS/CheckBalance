...
class DataBaseTest {
    ...
    Card card1 = new BankCard("4256123542131234", "12/21", "IVAN", "PETROV", 1532, 652, BankCardType.DEBET);
    Card card2 = new BankCard("4256123542134526", "12/21", "IVAN", "PETROV", 1532, 652, BankCardType.DEBET);
